...
<div class="panel panel-default mukheroHack ">
	<div class="panel-heading panel-red-heading">
		<span class="panel-heading-text"> {{ __('messages.collaborator.edit.pageOne.title')
			}}</span>
	</div>

	<div class="panel-body">
		{{Form::open(['url' => '/editColaborator/page9'])}}
		...
		<div class="row">
			<div class="col-lg-12 ">{!!Form::submit('Confirmar',['class' => 'btn
				pull-right']); !!}</div>
		</div>
		{{Form::close()}}
	</div>
