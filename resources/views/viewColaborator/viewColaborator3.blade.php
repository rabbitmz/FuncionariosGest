				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-lg-2">{!! Form::text('house',$professional->casa,['class' =>
							'form-control ', 'type'=>'Number','id' => 'house','disabled'])
							!!}</div>
					</div>
				</div>
			</div>
